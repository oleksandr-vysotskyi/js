...
function roundCylinder(radius, height) {
...
function crateListItems(text, count) {
    document.write(`<ul>`)
...
function createListOfPrims(arr) {
    document.write(`<ul>`)
    //------using forEach-------
...
function createListOfUsers(arr) {
    document.write(`<ul>`)
