...
// #TYj7ncx
// За допомогою циклу for і document.write() вивести 10 блоків div с довільним текстом і індексом усередині

for (let i = 0; i < 10; i++) {
    document.write(`<div> cycle ${i} </div>`);
}


// #uzkt71dp
// За допомогою циклу while вивести в документ 20 блоків h1 с довільним текстом усередині.
let i = 0;
...
// #OeT7t3uUMFi
// За допомогою циклу while вивести в документ 20 блоків h1 с довільним текстом і індексом усередині.
let c = 0;
while (c < 20) {
    document.write(`<h1> while cycle ${c} </h1>`);
    c++;
}
...
let products = [
    ...
    },
    {
        title: 'tea',
        price: 15,
        image: 'https://www.shutterstock.com/image-photo/white-tea-cup-refreshing-hot-260nw-2461982285.jpg'
    }
]
